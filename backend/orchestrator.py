...
# async def run_simulation_stream(idea: str, session_id: str, fast: bool = False):
#     """
...
#     # KEY: ceo_revise receives compressed summaries, not full critique content.
#     # This is the fix for the context window bomb.
...
#         # Pass consensus_critiques which now each have a "summary" key
...
#                 "score":   s["score"],
#             })
#             # Update summary on the original critique for next revision round
